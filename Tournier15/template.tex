...
\begin{frame}
 ...
 \TikzDraw {
  \visible<2> {
    \node [fill=BULLET!50, draw=black!50, rounded corners=3mm, text opacity=1, fill opacity=0.7] at (0.3, -2.8) {\Huge \color{yellow}$(\BOLD{M}-h^2\BOLD{K})\BOLD{v}_+=\BOLD{p}+h\BOLD{f}$};
  }
 }
 %\gridlines
\end{frame}
